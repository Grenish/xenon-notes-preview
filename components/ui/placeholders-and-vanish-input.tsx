  ...
  const getContainerStyles = () => {
    ...
    switch (variant) {
      ...
      case "minimal":
        return cn(
          baseStyles,
          "bg-gray-50 border border-zinc-100",
          focused && "border-zinc-300"
        );
      case "outlined":
        return cn(
          baseStyles,
      ...
      case "glass":
        return cn(
          ...
          focused && "bg-white/80 border-white/30"
        );
      case "neumorphic":
        return cn(
          baseStyles,
          "bg-[#f0f0f3]",
          "shadow-[6px_6px_10px_0px_rgba(0,0,0,0.1),-6px_-6px_10px_0px_rgba(255,255,255,0.8)]",
          focused && "shadow-[inset_4px_4px_8px_0px_rgba(0,0,0,0.1),inset_-4px_-4px_8px_0px_rgba(255,255,255,0.8)]"
        );
      case "glow":
        return cn(
          baseStyles,
          ...
          focused && "shadow-[0_0_20px_4px_rgba(99,102,241,0.3)] border-blue-200/50"
        );
      case "accent":
        return cn(
          baseStyles,
          ...
          focused && "border-blue-500/60 shadow-[0_0_0_4px_rgba(59,130,246,0.1)]"
        );
      case "frosted":
        return cn(
          baseStyles,
          ...
          "shadow-[0px_8px_16px_-6px_rgba(0,0,0,0.08),inset_0_0_0_1px_rgba(255,255,255,0.5)]",
          focused && "bg-white/30 border-white/60"
        );
      case "layered":
        return cn(
          baseStyles,
          ...
          "after:content-[''] after:absolute after:-z-10 after:top-[4px] after:left-[5px] after:w-[calc(100%-10px)] after:h-full after:bg-gray-50 after:rounded-full",
          "before:content-[''] before:absolute before:-z-20 before:top-[8px] before:left-[10px] before:w-[calc(100%-20px)] before:h-full before:bg-gray-100 before:rounded-full",
      ...
      case "elegant":
        return cn(
          ...
          focused && "shadow-[0_20px_25px_-5px_rgba(0,0,0,0.05),0_10px_10px_-5px_rgba(0,0,0,0.01)] border-gray-300/80"
        );
      case "cosmic":
        return cn(
          baseStyles, 
          ...
          focused && "border-indigo-300/50 shadow-[0_0_20px_rgba(99,102,241,0.25)]"
        );
      default:
        return cn(
          baseStyles,
    ...
    >
      ...
      <div className="relative h-full flex items-center">
        ...
        <motion.div
          ...
          className="absolute left-4 sm:left-5 text-gray-400 z-10"
        >
        ...
        <input
          ...
          type="email"
          className={cn(
            "w-full relative text-sm sm:text-base z-50 border-none text-black bg-transparent h-full rounded-full focus:outline-none focus:ring-0 pl-10 sm:pl-12 pr-20",
        ...
        >
          <ArrowRight 
            className={cn(
              ...
              value && isEmail ? "text-white" : "text-gray-500"
            )}
        ...
        <AnimatePresence mode="wait">
          ...
          {!value && (
            <motion.p
              ...
              className="text-sm sm:text-base font-normal text-neutral-500 pl-10 sm:pl-12 text-left w-[calc(100%-5rem)] truncate"
            >
